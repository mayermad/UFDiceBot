...
public class BSCommand implements ICommand {
    @Override
    public void handle(CommandContext ctx) {
        ...
        try {
            ...
            int target = SQLManager.getCharacteristic("bs", ctx.getAuthor().getId());
            builder.append(" Dein BS ist ").append(target).append(". \n");
