package me.mayermad.jdabot.command.commands.basicSkills;
...
public class OutdoorSurvivalCommand implements ICommand {
    @Override
    public void handle(CommandContext ctx) {
        ...
        try {
            ...
            int target = SQLManager.getBasicSkill("outdoorSurvival", ctx.getAuthor().getId()) + SQLManager.getCharacteristic("int", ctx.getAuthor().getId());
            builder.append(" Dein Outdoor Survival Skill ist ").append(target).append(". \n");
