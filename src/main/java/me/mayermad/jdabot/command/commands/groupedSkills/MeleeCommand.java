...
public class MeleeCommand implements ICommand {
    //Basic, Brawling, Cavalry, Fencing, Flail, Parry, Pole-Arm, Two Handed
    @Override
    public void handle(CommandContext ctx) {
        ...
        try {
            ...
            int target = SQLManager.getBasicSkill("melee", ctx.getAuthor().getId()) + SQLManager.getCharacteristic("ws", ctx.getAuthor().getId());
            builder.append(" Dein Melee Skill ist ").append(target).append(". \n");
