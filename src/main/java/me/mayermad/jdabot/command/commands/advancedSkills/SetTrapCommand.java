...
public class SetTrapCommand implements ICommand {
    @Override
    public void handle(CommandContext ctx) {
        ...
        try {
            ...
            int skill = SQLManager.getAdvancedSkill("setTrap", ctx.getAuthor().getId());
            if (skill == -1 ) {
            ...
            builder.append(" Dein Set Trap Skill ist ").append(target).append(". \n");
