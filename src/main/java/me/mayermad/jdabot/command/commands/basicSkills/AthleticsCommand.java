...
public class AthleticsCommand implements ICommand {
    @Override
    public void handle(CommandContext ctx) {
        ...
        try {
            ...
            int target = SQLManager.getBasicSkill("athletics", ctx.getAuthor().getId()) + SQLManager.getCharacteristic("ag", ctx.getAuthor().getId());
            builder.append(" Dein Athletics Skill ist ").append(target).append(". \n");
