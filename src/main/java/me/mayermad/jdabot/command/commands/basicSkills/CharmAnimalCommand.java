...
public class CharmAnimalCommand implements ICommand {
    @Override
    public void handle(CommandContext ctx) {
        ...
        try {
            ...
            int target = SQLManager.getBasicSkill("charmAnimal", ctx.getAuthor().getId()) + SQLManager.getCharacteristic("wp", ctx.getAuthor().getId());
            builder.append(" Dein Art Charm Animal ist ").append(target).append(". \n");
