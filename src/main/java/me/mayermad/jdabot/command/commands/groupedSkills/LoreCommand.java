...
public class LoreCommand implements ICommand {
    //engineering, geology, heraldry, history, law, magick, metallurgy, science, theology
    @Override
    public void handle(CommandContext ctx) {
        ...
        try {
            ...
            arguments.add(zero);
            String speciality = SQLManager.getStandard( "lore", ctx.getAuthor().getId());
            ...
            int skill = SQLManager.getGroupedSkill("lore", speciality, ctx.getAuthor().getId());
            if (skill == -1 ) {
