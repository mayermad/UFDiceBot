...
public class FelCommand implements ICommand {
    @Override
    public void handle(CommandContext ctx) {
        ...
        try {
            ...
            int target = SQLManager.getCharacteristic("fel", ctx.getAuthor().getId());
            builder.append(" Dei Fel ist ").append(target).append(". \n");
