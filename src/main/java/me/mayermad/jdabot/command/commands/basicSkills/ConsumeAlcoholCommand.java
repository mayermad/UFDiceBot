...
public class ConsumeAlcoholCommand implements ICommand {
    @Override
    public void handle(CommandContext ctx) {
        ...
        try {
            ...
            int target = SQLManager.getBasicSkill("consumeAlcohol", ctx.getAuthor().getId()) + SQLManager.getCharacteristic("t", ctx.getAuthor().getId());
            builder.append(" Dein Consume Alcohol Skill ist ").append(target).append(". \n");
