...
public class PickLockCommand implements ICommand {
    @Override
    public void handle(CommandContext ctx) {
        ...
        try {
            ...
            int skill = SQLManager.getAdvancedSkill("pickLock", ctx.getAuthor().getId());
            if (skill == -1 ) {
            ...
            builder.append(" Dein Pick Lock Skill ist ").append(target).append(". \n");
