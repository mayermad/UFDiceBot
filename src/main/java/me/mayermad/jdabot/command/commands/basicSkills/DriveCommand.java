...
public class DriveCommand implements ICommand {
    ...
    public void handle(CommandContext ctx) {
        ...
        try {
            ...
            int target = SQLManager.getBasicSkill("drive", ctx.getAuthor().getId()) + SQLManager.getCharacteristic("ag", ctx.getAuthor().getId());
            builder.append(" Dein Drive Skill ist ").append(target).append(". \n");
