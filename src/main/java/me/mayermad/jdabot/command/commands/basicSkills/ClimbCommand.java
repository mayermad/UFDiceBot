...
public class ClimbCommand implements ICommand {
    ...
    public void handle(CommandContext ctx) {
        ...
        try {
            ...
            int target = SQLManager.getBasicSkill("climb", ctx.getAuthor().getId()) + SQLManager.getCharacteristic("s", ctx.getAuthor().getId());
            builder.append(" Dein Climb Skill ist ").append(target).append(". \n");
