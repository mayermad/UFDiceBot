...
public class StealthCommand implements ICommand {
    ...
    public void handle(CommandContext ctx) {
        ...
        try {
            ...
            int target = SQLManager.getBasicSkill("stealth", ctx.getAuthor().getId()) + SQLManager.getCharacteristic("ag", ctx.getAuthor().getId());
            builder.append(" Dein Stealth Skill ist ").append(target).append(". \n");
