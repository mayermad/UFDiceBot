...
public class LeadershipCommand implements ICommand {
    @Override
    public void handle(CommandContext ctx) {
        ...
        try {
            ...
            int target = SQLManager.getBasicSkill("leadership", ctx.getAuthor().getId()) + SQLManager.getCharacteristic("fel", ctx.getAuthor().getId());
            builder.append(" Dein Leadership Skill ist ").append(target).append(". \n");
