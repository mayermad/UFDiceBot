...
public class WSCommand implements ICommand {
    @Override
    public void handle(CommandContext ctx) {
        ...
        try {
            ...
            int target = SQLManager.getCharacteristic("ws", ctx.getAuthor().getId());
            builder.append(" Dein WS ist ").append(target).append(". \n");
