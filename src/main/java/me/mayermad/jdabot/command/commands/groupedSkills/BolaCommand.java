...
public class BolaCommand implements ICommand {
    ...
    public void handle(CommandContext ctx) {
        ...
        try {
            ...
            int skill = SQLManager.getGroupedSkill("ranged", "entangling", ctx.getAuthor().getId());
            if (skill == -1 ) {
            ...
            builder.append(" Dein Ranged (Entangling) Skill ist ").append(target).append(". \n");
