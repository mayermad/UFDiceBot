...
public class DodgeCommand implements ICommand {
    ...
    public void handle(CommandContext ctx) {
        ...
        try {
            ...
            int target = SQLManager.getBasicSkill("dodge", ctx.getAuthor().getId()) + SQLManager.getCharacteristic("ag", ctx.getAuthor().getId());
            builder.append(" Dein Dodge Skill ist ").append(target).append(". \n");
