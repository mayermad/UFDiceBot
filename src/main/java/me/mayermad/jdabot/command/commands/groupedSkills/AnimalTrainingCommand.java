...
public class AnimalTrainingCommand implements ICommand {
    //Demigryph, Dog, Horse, Pegasus, Pigeon
    ...
    public void handle(CommandContext ctx) {
        ...
        try {
            ...
            arguments.add(zero);
            String speciality = SQLManager.getStandard( "animalTraining", ctx.getAuthor().getId());
            ...
            int skill = SQLManager.getGroupedSkill("animalTraining", speciality, ctx.getAuthor().getId());
            if (skill == -1 ) {
            ...
            builder.append(" Dein Animal Training (").append(speciality).append(") Skill ist ").append(target).append(". \n");
