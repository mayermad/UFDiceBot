...
public class PerceptionCommand implements ICommand {
    @Override
    public void handle(CommandContext ctx) {
        ...
        try {
            ...
            int target = SQLManager.getBasicSkill("perception", ctx.getAuthor().getId()) + SQLManager.getCharacteristic("i", ctx.getAuthor().getId());
            builder.append(" Dein Perception Skill ist ").append(target).append(". \n");
