...
public class MeleeBasicCommand implements ICommand {
    @Override
    public void handle(CommandContext ctx) {
        ...
        try {
            ...
            int target = SQLManager.getBasicSkill("MeleeBasic", ctx.getAuthor().getId()) + SQLManager.getCharacteristic("ws", ctx.getAuthor().getId());
            builder.append(" Dein Melee (Basic) Skill ist ").append(target).append(". \n");
