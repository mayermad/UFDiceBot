...
public class SleightOfHandCommand implements ICommand {
    @Override
    public void handle(CommandContext ctx) {
        ...
        try {
            ...
            int skill = SQLManager.getAdvancedSkill("sleightOfHand", ctx.getAuthor().getId());
            if (skill == -1 ) {
            ...
            builder.append(" Dein Sleight Of Hand Skill ist ").append(target).append(". \n");
