...
public class GossipCommand implements ICommand {
    @Override
    public void handle(CommandContext ctx) {
        ...
        try {
            ...
            int target = SQLManager.getBasicSkill("gossip", ctx.getAuthor().getId()) + SQLManager.getCharacteristic("fel", ctx.getAuthor().getId());
            builder.append(" Dein Gossip Skill ist ").append(target).append(". \n");
