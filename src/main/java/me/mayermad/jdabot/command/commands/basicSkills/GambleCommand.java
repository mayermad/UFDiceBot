...
public class GambleCommand implements ICommand {
    ...
    public void handle(CommandContext ctx) {
        ...
        try {
            ...
            int target = SQLManager.getBasicSkill("gamble", ctx.getAuthor().getId()) + SQLManager.getCharacteristic("int", ctx.getAuthor().getId());
            builder.append(" Dein Gamble Skill ist ").append(target).append(". \n");
