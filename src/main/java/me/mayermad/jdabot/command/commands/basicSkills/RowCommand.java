...
public class RowCommand implements ICommand {
    @Override
    public void handle(CommandContext ctx) {
        ...
        try {
            ...
            int target = SQLManager.getBasicSkill("row", ctx.getAuthor().getId()) + SQLManager.getCharacteristic("s", ctx.getAuthor().getId());
            builder.append(" Dein Row Skill ist ").append(target).append(". \n");
