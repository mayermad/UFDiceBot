...
public class IntuitionCommand implements ICommand {
    @Override
    public void handle(CommandContext ctx) {
        ...
        try {
            ...
            int target = SQLManager.getBasicSkill("intuition", ctx.getAuthor().getId()) + SQLManager.getCharacteristic("i", ctx.getAuthor().getId());
            builder.append(" Dein Intuition Skill ist ").append(target).append(". \n");
