...
public class CharmCommand implements ICommand {
    @Override
    public void handle(CommandContext ctx) {
        ...
        try {
            ...
            int target = SQLManager.getBasicSkill("charm", ctx.getAuthor().getId()) + SQLManager.getCharacteristic("fel", ctx.getAuthor().getId());
            builder.append(" Dein Charm Skill ist ").append(target).append(". \n");
