...
public class BriberyCommand implements ICommand {
    @Override
    public void handle(CommandContext ctx) {
        ...
        try {
            ...
            int target = SQLManager.getBasicSkill("bribery", ctx.getAuthor().getId()) + SQLManager.getCharacteristic("fel", ctx.getAuthor().getId());
            builder.append(" Dein Bribery Skill ist ").append(target).append(". \n");
