package me.mayermad.jdabot.command.commands.characteristics;
...
public class IntCommand implements ICommand {
    @Override
    public void handle(CommandContext ctx) {
        ...
        try {
            ...
            int target = SQLManager.getCharacteristic("int", ctx.getAuthor().getId());
            builder.append(" Deine Int ist ").append(target).append(". \n");
