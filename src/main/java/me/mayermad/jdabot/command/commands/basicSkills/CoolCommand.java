...
public class CoolCommand implements ICommand {
    ...
    public void handle(CommandContext ctx) {
        ...
        try {
            ...
            int target = SQLManager.getBasicSkill("cool", ctx.getAuthor().getId()) + SQLManager.getCharacteristic("wp", ctx.getAuthor().getId());
            builder.append(" Dein Cool Skill ist ").append(target).append(". \n");
