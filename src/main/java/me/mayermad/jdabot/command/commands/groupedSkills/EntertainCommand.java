...
public class EntertainCommand implements ICommand {
    ...
    public void handle(CommandContext ctx) {
        ...
        try {
            ...
            int target = SQLManager.getBasicSkill("entertain", ctx.getAuthor().getId()) + SQLManager.getCharacteristic("fel", ctx.getAuthor().getId());
            builder.append(" Dein Entertain Skill ist ").append(target).append(". \n");
