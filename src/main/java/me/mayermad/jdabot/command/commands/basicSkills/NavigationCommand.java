...
public class NavigationCommand implements ICommand {
    ...
    public void handle(CommandContext ctx) {
        ...
        try {
            ...
            int target = SQLManager.getBasicSkill("navigation", ctx.getAuthor().getId()) + SQLManager.getCharacteristic("i", ctx.getAuthor().getId());
            builder.append(" Dein Navigation Skill ist ").append(target).append(". \n");
