...
public class IntimidateCommand implements ICommand {
    @Override
    public void handle(CommandContext ctx) {
        ...
        try {
            ...
            int target = SQLManager.getBasicSkill("intimidate", ctx.getAuthor().getId()) + SQLManager.getCharacteristic("s", ctx.getAuthor().getId());
            builder.append(" Dein Intimidate Skill ist ").append(target).append(". \n");
