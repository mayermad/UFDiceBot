...
public class AgCommand implements ICommand {
    @Override
    public void handle(CommandContext ctx) {
        ...
        try {
            ...
            int target = SQLManager.getCharacteristic("ag", ctx.getAuthor().getId());
            builder.append(" Deine Ag ist ").append(target).append(". \n");
