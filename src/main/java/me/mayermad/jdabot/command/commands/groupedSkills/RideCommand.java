...
public class RideCommand implements ICommand {
    //Demigryph, Great Wolf, Griffon, Horse, Pegasus
    @Override
    public void handle(CommandContext ctx) {
        ...
        try {
            ...
            int target = SQLManager.getBasicSkill("ride", ctx.getAuthor().getId()) + SQLManager.getCharacteristic("ag", ctx.getAuthor().getId());
            builder.append(" Dein Ride Skill ist ").append(target).append(". \n");
