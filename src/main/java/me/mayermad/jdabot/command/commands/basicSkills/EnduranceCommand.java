...
public class EnduranceCommand implements ICommand {
    @Override
    public void handle(CommandContext ctx) {
        ...
        try {
            ...
            int target = SQLManager.getBasicSkill("endurance", ctx.getAuthor().getId()) + SQLManager.getCharacteristic("t", ctx.getAuthor().getId());
            builder.append(" Dein Endurance Skill ist ").append(target).append(". \n");
