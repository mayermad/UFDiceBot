...
public class WPCommand implements ICommand {
    @Override
    public void handle(CommandContext ctx) {
        ...
        try {
            ...
            int target = SQLManager.getCharacteristic("wp", ctx.getAuthor().getId());
            builder.append(" Deine WP ist ").append(target).append(". \n");
